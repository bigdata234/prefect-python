# -*- coding: utf-8 -*-
# @Time    : 2018/4/21 18:29
# @Author  : Jiao Ruiqiang
# @Email   : jiaoruiqiang@bbdservice.com
# @File    : IC_Sum_Loan5YearsOverdueMon.py
# @Software: PyCharm

'''eof
name:贷款5年内逾期月份数最大值
code:IC_Sum_Loan5YearsOverdueMon
tableName:
columnName:
groups:个人征信
dependencies:IC
...
def IC_Sum_Loan5YearsOverdueMon():
...
result = IC_Sum_Loan5YearsOverdueMon()